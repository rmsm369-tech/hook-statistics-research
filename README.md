...
Exact literal enumeration of 2D self-conjugate Ferrers diagrams up to n=100 confirms the Craig-Ono-Singh baseline (\mu_1(100) \approx 7.838) and proves the O(n^{-1/2}) periodic residual does not diverge. The scaled error remains strictly bounded, confirming the oscillatory secondary term.
